      ...
      examples: [
        {
          ...
          files: [
            {
              name: "server.js",
              filePath: "lib/DATABASE GUIDES/MONGODB/1. MongoDB Setup/server.js",
              description: "Express server with MongoDB connection",
              order: 1,
            },
            {
              name: ".env",
              filePath: "lib/DATABASE GUIDES/MONGODB/1. MongoDB Setup/.env.example",
        ...
        },
        {
          ...
          files: [
            {
              name: "models/User.js",
              filePath: "lib/DATABASE GUIDES/MONGODB/2. Schema and Model/User.js",
          ...
          files: [
            {
              ...
              filePath: "lib/DATABASE GUIDES/MONGODB/3. CRUD Operations/users.js",
      ...
      examples: [
        {
          ...
          files: [
            {
              name: "db.js",
              filePath: "lib/DATABASE GUIDES/POSTGRESQL/1. Setup/db.js",
