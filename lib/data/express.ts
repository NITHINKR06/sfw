      ...
      examples: [
        {
          ...
          files: [
            {
              name: "server.js",
              filePath: "lib/EXPRESS JS EXAMPLES/Program1_Basic.js.txt",
        ...
        },
        {
          ...
          files: [
            {
              name: "server.js",
              filePath: "lib/EXPRESS JS EXAMPLES/Program2_GETPOST.js.txt",
        ...
        },
        {
          ...
          files: [
            {
              name: "server.js",
              filePath: "lib/EXPRESS JS EXAMPLES/Program3_GETPOST.js.txt",
              description: "Server handling form data",
              order: 1,
            },
            {
              name: "form.html",
              filePath: "lib/EXPRESS JS EXAMPLES/Program3_FORM.HTML.txt",
        ...
        },
        {
          ...
          files: [
            {
              name: "server.js",
              filePath: "lib/EXPRESS JS EXAMPLES/Program4_URlParam.js.txt",
        ...
        },
        {
          ...
          files: [
            {
              name: "server.js",
              filePath: "lib/EXPRESS JS EXAMPLES/Program5_QueryString.js.txt",
        ...
        },
        {
          ...
          files: [
            {
              name: "server.js",
              filePath: "lib/EXPRESS JS EXAMPLES/program6_StaticPage.js.txt",
