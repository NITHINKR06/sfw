      ...
      examples: [
        {
          ...
          files: [
            {
              name: "App.jsx",
              filePath: "lib/5. Conditional Rendering in React/1. SIMPLE IF.txt",
        ...
        },
        {
          ...
          files: [
            {
              name: "App.jsx",
              filePath: "lib/5. Conditional Rendering in React/2. TERNARY OPERATOR.txt",
        ...
        },
        {
          ...
          files: [
            {
              name: "App.jsx",
              filePath: "lib/5. Conditional Rendering in React/3 LOGICAL AND.txt",
        ...
        },
        {
          ...
          files: [
            {
              name: "App.jsx",
              filePath: "lib/5. Conditional Rendering in React/4 PUTTING ALL TOGETHER.txt",
      ...
      examples: [
        {
          ...
          files: [
            {
              name: "App.jsx",
              filePath: "lib/6 LISTS AND KEYS IN REACT/1. EXAMPLE 1.txt",
        ...
        },
        {
          ...
          files: [
            {
              name: "App.jsx",
              filePath: "lib/6 LISTS AND KEYS IN REACT/2. TO DO LIST EXAMPLE.txt",
      ...
      examples: [
        {
          ...
          files: [
            {
              name: "App.jsx",
              filePath: "lib/7. UseEffect in React JS/1. PROGRAM 1.txt",
        ...
        },
        {
          ...
          files: [
            {
              name: "App.jsx",
              filePath: "lib/7. UseEffect in React JS/2. PROGRAM 2 RUN ONLY ONCE.txt",
        ...
        },
        {
          ...
          files: [
            {
              name: "App.jsx",
              filePath: "lib/7. UseEffect in React JS/3. PROGRAM 3 RUN ONLY ONCE.txt",
        ...
        },
        {
          ...
          files: [
            {
              name: "App.jsx",
              filePath: "lib/7. UseEffect in React JS/4. PROGRAM 4 USEEFFECT WITH DEPENDENCIES.txt",
        ...
        },
        {
          ...
          files: [
            {
              name: "App.jsx",
              filePath: "lib/7. UseEffect in React JS/5. PROGRAM 5 USEEFFECT FETCHING DATA.txt",
        ...
        },
        {
          ...
          files: [
            {
              name: "App.jsx",
              filePath: "lib/7. UseEffect in React JS/6. PROGRAM 6 USEEFFECT TIMER.txt",
        ...
        },
        {
          ...
          files: [
            {
              name: "App.jsx",
              filePath: "lib/7. UseEffect in React JS/7. PROGRAM 7 CLEANUP EVENT LISTENER.txt",
      ...
      examples: [
        {
          ...
          files: [
            {
              name: "App.jsx",
              filePath: "lib/8. Useref Hook in React JS/1. PROGRAM 1 USEREF COUNTER.txt",
        ...
        },
        {
          ...
          files: [
            {
              name: "App.jsx",
              filePath: "lib/8. Useref Hook in React JS/2. PROGRAM 2 ACCESS DOM.txt",
        ...
        },
        {
          ...
          files: [
            {
              name: "App.jsx",
              filePath: "lib/8. Useref Hook in React JS/3. PROGRAM 3 STATE CHANGE.txt",
      ...
      examples: [
        {
          ...
          files: [
            {
              name: "App.jsx",
              filePath: "lib/9. REACT ROUTING/PROGRAM 1/APP.JSX.txt",
              description: "Main App component with routing setup",
              order: 1,
            },
            {
              name: "Home.jsx",
              filePath: "lib/9. REACT ROUTING/PROGRAM 1/Home.jsx.txt",
              description: "Home page component",
              order: 2,
            },
            {
              name: "About.jsx",
              filePath: "lib/9. REACT ROUTING/PROGRAM 1/About.jsx.txt",
              description: "About page component",
              order: 3,
            },
            {
              name: "Contact.jsx",
              filePath: "lib/9. REACT ROUTING/PROGRAM 1/Contact.jsx.txt",
        ...
        },
        {
          ...
          files: [
            {
              name: "App.jsx",
              filePath: "lib/9. REACT ROUTING/PROGRAM 2 NOT FOUND/APP.JSX.txt",
              description: "App with 404 route",
              order: 1,
            },
            {
              name: "NotFound.jsx",
              filePath: "lib/9. REACT ROUTING/PROGRAM 2 NOT FOUND/NotFound.jsx.txt",
              description: "404 Not Found component",
              order: 2,
            },
            {
              name: "Home.jsx",
              filePath: "lib/9. REACT ROUTING/PROGRAM 2 NOT FOUND/Home.jsx.txt",
              description: "Home component",
              order: 3,
            },
            {
              name: "About.jsx",
              filePath: "lib/9. REACT ROUTING/PROGRAM 2 NOT FOUND/About.jsx.txt",
              description: "About component",
              order: 4,
            },
            {
              name: "Contact.jsx",
              filePath: "lib/9. REACT ROUTING/PROGRAM 2 NOT FOUND/Contact.jsx.txt",
        ...
        },
        {
          ...
          files: [
            {
              name: "App.jsx",
              filePath: "lib/9. REACT ROUTING/PROGRAM 3 NESTED ROUTING/App.jsx.txt",
              description: "App with nested routes",
              order: 1,
            },
            {
              name: "About.jsx",
              filePath: "lib/9. REACT ROUTING/PROGRAM 3 NESTED ROUTING/About.jsx.txt",
              description: "Parent route with Outlet",
              order: 2,
            },
            {
              name: "Team.jsx",
              filePath: "lib/9. REACT ROUTING/PROGRAM 3 NESTED ROUTING/Team.jsx.txt",
              description: "Nested child route",
              order: 3,
            },
            {
              name: "Company.jsx",
              filePath: "lib/9. REACT ROUTING/PROGRAM 3 NESTED ROUTING/Company.jsx.txt",
              description: "Nested child route",
              order: 4,
            },
            {
              name: "Home.jsx",
              filePath: "lib/9. REACT ROUTING/PROGRAM 3 NESTED ROUTING/Home.jsx.txt",
              description: "Home component",
              order: 5,
            },
          ],
        ...
        },
        {
          ...
          files: [
            {
              name: "App.jsx",
              filePath: "lib/9. REACT ROUTING/PROGRAM 4 PARAMETER PASSING/App.jsx.txt",
